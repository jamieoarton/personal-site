...
The pattern is consistent: leadership buys the tools, announces the strategy, and assumes adoption will follow. It doesn't.
...
They're deeply connected. Governance provides the framework (approved tools, data policies, usage guidelines). Change management ensures people understand and follow that framework. Without governance, change management has no structure. Without change management, governance is just a policy nobody reads.
